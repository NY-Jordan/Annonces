                ...
                <div class="order-xl-2 order-lg-2 col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="gradient-wrapper item-mb">
                        ...
                        <div id="category-view" class="category-list-layout2 gradient-padding zoom-gallery">
                            <div class="row">
                                @if (empty($postByLocation))
                                    <h3 >Aucunes annonces pour cette ville</h3>
                                @endif
                                @foreach ($postByLocation as $post)
                                        ...
                                        <div class="product-box item-mb zoom-gallery">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <h3 class="short-title"><a
                                                        href="{{ route('postDetails', $post->id) }}">{{  $k = (strlen($post->title) > 15) ? substr($post->title, 0, 15).'...' : $post->title  }}</a>
                                                </h3>

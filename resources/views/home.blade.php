                ...
                <div class="order-xl-2 order-lg-2 col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12 mb--sm">
                    ...
                    <div class="cp-carousel nav-control-top category-grid-layout2" data-loop="true" data-items="3"
                        ...
                        <div class="product-box item-mb zoom-gallery">
                            <div class="item-mask-wrapper">
                                <div class="item-mask bg-body">
                                    <img src="../img/product/product17.png" alt="categories" class="img-fluid">
                            ...
                            <div class="item-content">
                                ...
                                <ul class="upload-info">
                                    <li class="date"><i class="fa fa-clock-o" aria-hidden="true"></i>07 Mar, 2017
                                    </li>
                                    <li class="place"><i class="fa fa-map-marker" aria-hidden="true"></i>Sydney,
                                        Australia
                                    </li>
                        ...
                        <div class="product-box item-mb zoom-gallery">
                            <div class="item-mask-wrapper">
                                <div class="item-mask bg-body">
                                    <img src="../img/product/product19.png" alt="categories" class="img-fluid">
                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt"
                                            aria-hidden="true"></i> </div>
                                    <div class="title-ctg">Clothing</div>
                                    <ul class="info-link">
                ...
                @foreach ($heightRecentPosts as $post)
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="product-box item-mb zoom-gallery">
                            <div class="item-mask-wrapper">
                                <div class="item-mask bg-body">
                                    <img src="{{ Storage::url($post->image->path) }}"   alt="categories" class="img-fluid">
                                    <div class="trending-sign" data-tips="Featured"> <i class="fa fa-bolt"
                                            aria-hidden="true"></i> </div>
                                    ...
                                    @if(isset($post->prenium->status))
                                        <div style="background-color: green; border-radius:10px; margin-top:10px; width:70px;   height:auto;"> {{ $post->prenium->status }}</div>
                                    @endif
                                </div>
                            </div>
                            <div class="item-content">

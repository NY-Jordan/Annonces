                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-7 col-md-7 col-sm-12 col-12">
                                    <div class="add-layout2-left d-flex align-items-center">
                                        <div>
                                            <h2>your ad has no visibility ?</h2>
                                            <h3>put your ad in prenium now</h3>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row d-md-flex">
                <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                    <div class="pricing-box bg-box">
                        ...
                        <a href="{{ route('addPostFree') }}" class="cp-default-btn-lg">Submit Ad</a>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                    <div class="pricing-box bg-box">
                        ...
                        <p>Post as many ads as you like for 30 days without limitations and 100% FREE SUBMIT AD</p>
                        <a href="{{ route('addPostPrenium') }}" class="cp-default-btn-lg">Submit Ad</a>
                    </div>
                </div>
            </div>
        </div>

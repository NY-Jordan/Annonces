                            ...
                            <div class="col-8">
                                <div class="layout-switcher">
                                    <ul>
                                        ...
                                        <li><a class="product-view-trigger" href="#" data-type="category-grid-layout2"><i class="fa fa-th-large"></i></a>
                                        </li>
                                ...
                                <div class="product-box item-mb zoom-gallery">
                                    ...
                                    <div class="item-content">
                                        ...
                                        <ul class="upload-info">
                                            <li class="date"><i class="fa fa-clock-o" aria-hidden="true"></i>{{ $post->created_at->format('F  m, Y') }}
                                            </li>
                                            <li class="place"><i class="fa fa-map-marker" aria-hidden="true"></i>{{ $post->user->sellerInformations->location->locationName }}
                                            </li>
                                            <li class="tag-ctg"><i class="fa fa-tag" aria-hidden="true"></i>{{ $post->catego }}
                                            </li>
                                        </ul>
                    ...
                    <div class="gradient-wrapper">
                        ...
                        <ul class="sidebar-category-list">
                            <ul class="sidebar-category-list">
                                ...
                                <li>
                                    <a href="{{ route('PostsByCategory', $category->id) }}"><img src="../img/product/ctg1.png" alt="category" class="img-fluid"><?= $category->categoryName ?><span>({{ $category->posts->count() }})</span></a>
                                </li>
                                @endforeach
                            </ul>
                        </ul>

                    ...
                    <div role="tabpanel" class="gradient-padding tab-pane fade" id="personal">
                        ...
                        <form id="login-page-form" method="POST" action="{{ route("updateInformations") }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-12">
                                    <div class="form-group">
                                        <input type="text" id="first-name2" name="email" value="{{ $user->email }}" class="form-control" placeholder="Enter your e-mail here . . .">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-12">
                                    <div class="form-group">
                                        <input type="text" id="first-name" name="Fisrt_name" value="{{  $user->first_name }}" class="form-control" placeholder="First Name">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-12">
                                    <div class="form-group">
                                        <input type="text" id="phone" name="Phone" value="{{ $user->sellerInformations->mobile_phone1 }}" class="form-control" placeholder="Your Phone Number">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-12">
                                    <div class="form-group">
                                        <input type="password" id="c-password" name="Current_Password" class="form-control" placeholder="Type  Your Password">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-12">
                                    <div class="form-group">
                                        <input type="password" id="n-password" name="New_Password" class="form-control" placeholder="Type  Your Password">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-8 col-12">
                                    <div class="form-group">
                                        <input type="password" name="Confirm_Password" id="r-password" class="form-control" placeholder="Type  Your Password">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                <div class="product-box item-mb zoom-gallery">
                                                    <div class="item-mask-wrapper">
                                                        <div class="item-mask secondary-bg-box"><img src="{{  Storage::url($post->image->path) }}" alt="categories" class="img-fluid">
                                                            ...
                                                            <ul class="info-link">
                                                                <li><a href="{{ Storage::url($post->image->path) }}" class="elv-zoom" data-fancybox-group="gallery" title="Title Here"><i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li>
                                                    ...
                                                    <div class="item-content">
                                                        ...
                                                        <h3 class="short-title"><a href="{{ route('postDetails', $post->id) }}">{{ $post->title }}</a></h3>
                                                        <h3 class="long-title"><a href="{{ route('postDetails', $post->id) }}">{{ $post->title }}</a></h3>
                                                        <ul class="upload-info">
                                                            <li class="date"><i class="fa fa-clock-o" aria-hidden="true"></i>{{ $post->created_at->format('j F, Y') }}</li>
                                                            ...
                                                            <li class="tag-ctg"><i class="fa fa-tag" aria-hidden="true"></i>{{ $post->categories->categoryName }}</li>
                                                        </ul>
                                                        <p>{{ substr($post->details, 0, 100).'...'  }}</p>
                                                        <div class="price">{{ $post->price }} Fcfa</div>
                                                        <a href="{{ route("postDetails", [ 'id' => $post->id])  }}" class="product-details-btn">Details</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach

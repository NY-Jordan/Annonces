        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-12">
                <div class="gradient-wrapper sidebar-item-box">
                    <ul class="nav tab-nav my-account-title">
                        <li class="nav-item"><a href="#posts" data-toggle="tab" aria-expanded="false">Posts</a></li>
                        <li class="nav-item"><a href="#users" class="active" data-toggle="tab" aria-expanded="false">Users</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-9 col-md-8 col-12">
                <div class="tab-content my-account-wrapper gradient-wrapper input-layout1">
                                                ...
                                                @foreach ($datas_users as $data)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                                <a href="{{ route('user.unblock', $data->id) }}"></a><button  class="btn btn-primary">unblock</button>
                                                            @endif
                    ...
                    <div role="tabpanel" class="tab-pane fade  show" id="posts">
                        <div class="row">
                            <div class="col-lg-12">
                                                                ...
                                                                @if (!empty($datas_posts))
                                                                    @foreach ($datas_posts as $data)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <p> {{ $data->user->sellerInformations->mobile_phone1 }}</p>
                                                                            </td>
                                                                            <td>
                                                                                {{ $data->status }}
                                                                            </td>
